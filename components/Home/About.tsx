  ...
  return (
    <div className="relative bg-[#8D6F57]">
      ...
      <div className="relative mx-auto max-w-7xl py-16 px-6 sm:py-32 sm:px-12 lg:px-8">
        <h1 className="tracking-widest text-[#f6f6f6] text-4xl md:text-5xl uppercase pb-2">
          About the Artist
        </h1>
        ...
        <div className="mt-12 sm:w-full sm:max-w-md lg:mt-8 lg:ml-0 lg:flex-1">
          <Link
            href="/about"
            className="inline-block tracking-widest border border-transparent bg-[#f6f6f6] py-3 px-8 text-[#2d241c] shadow-lg hover:brightness-110"
          >
            READ MORE
          </Link>
        </div>
