    ...
    <div className="lg:relative">
      <div className="mx-auto w-full max-w-7xl pt-16 pb-20 text-center lg:py-36 lg:text-left">
        <div className="px-4 sm:px-8 lg:w-1/2 xl:pr-16">
          ...
          <h3 className="text-4xl md:text-5xl uppercase font-medium tracking-widest opacity-95 pb-2">
            AMONG THE LIVING
          </h3>
          ...
          <Link
            ...
            className="mt-12 inline-block tracking-widest border border-transparent py-3 px-8 text-[#f6f6f6] shadow-lg hover:brightness-90 bg-[#8D6F57]"
          >
            MORE INFO
          </Link>
        </div>
