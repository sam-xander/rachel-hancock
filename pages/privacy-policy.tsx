...
export default function PrivacyPolicy() {
  return (
    <>
      ...
      <div className="max-w-3xl mx-auto leading-loose my-20">
        <h1 className="text-2xl">Privacy Policy</h1>
        <p className="mb-12">Last updated: September 21, 2022</p>
        <p>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Rachel Hancock.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Rachel Hancock, accessible from{" "}
              <Link
                href="https://rachelhancock.co.uk"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://rachelhancock.co.uk
              </Link>
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>By email: info@rachelhancock.co.uk</li>
        </ul>
      </div>
    </>
  );
